...
class ProductDetail extends StatefulWidget {
  ...
  ProductDetail({this.snapshot, this.index, this.callback});
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () async {
              ...
              setState(() {
                isFav = isFavourite;
                widget.callback(widget.index != null ? widget.index : 0);
                print(isFav);
                print("hola");
              });
            },
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                padding: EdgeInsets.symmetric(vertical: 10),
                                child: Text(
                                  "You will need to pay deposit amount upfront. Monthly rent will be collected each month from your delivery date.",
                                  style: Theme.of(context)
                                      .textTheme
                                      .caption
                                      .copyWith(color: Colors.black87),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                padding: EdgeInsets.symmetric(vertical: 10),
                                child: Text(
                                  "Rent agreement will remain valid for the tenure you\'ve selected. In order to continue using the product, you will need to rent the item again.",
                                  style: Theme.of(context)
                                      .textTheme
                                      .caption
                                      .copyWith(color: Colors.black87),
