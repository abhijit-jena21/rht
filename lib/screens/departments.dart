  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          ...
          //       height: 200,
          //       decoration: BoxDecoration(image: DecorationImage(image: AssetImage("assets/images/bgimg.jpg")),
...
class EntryItem extends StatelessWidget {
  ...
  Widget _buildTiles(Entry root) {
    ...
    return ExpansionTile(
      ...
      leading: Image.asset(root.image, width: 50),
      title: Container(
        child: Text(
          root.title,
        ),
